...
public class Teste extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(CampoConfSenha, javax.swing.GroupLayout.PREFERRED_SIZE, 158, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(CampoSenha, javax.swing.GroupLayout.PREFERRED_SIZE, 158, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel2)
                    .addComponent(campoUsuario, javax.swing.GroupLayout.PREFERRED_SIZE, 158, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        JPasswordField senha1 = CampoSenha;
        char[] senhaCharArray = senha1.getPassword();
        String senha = new String(senhaCharArray);

        JPasswordField senha2 = CampoConfSenha;
        char[] senhaConfCharArray = senha2.getPassword();
        String senhaConf = new String(senhaConfCharArray);

        if ((senhaCharArray.length == 0)
                || (senhaConfCharArray.length == 0)
